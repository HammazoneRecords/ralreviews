...
import { getFeedbackForRestaurant, deleteFeedback as deleteFeedbackFromDB } from '@/lib/firebase';
...
import { Utensils, MessageSquare, Star, Lightbulb, Loader2, Wand2 } from 'lucide-react';
...
function AdminDashboard() {
  ...
  useEffect(() => {
    const loadData = async () => {
        ...
        const restaurantsWithFeedback = await Promise.all(
        ...
        // Find the restaurant with the most feedback to pre-load suggestions
        if (updatedRestaurants.length > 0) {
            ...
            if (restaurantWithMostFeedback && restaurantWithMostFeedback.id) {
                // Pre-select the restaurant in the dropdown
  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 py-8 md:px-8 md:py-12">
        <h1 className="text-3xl md:text-4xl font-headline text-center mb-8">Admin Dashboard</h1>
        ...
        <section>
             <h2 className="text-2xl font-headline mb-4">Restaurant Details</h2>
             {isLoading ? (
